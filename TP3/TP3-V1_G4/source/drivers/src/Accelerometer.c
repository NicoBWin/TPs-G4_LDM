...
void proccess_data(SRAWDATA Data_Accel_Mag )
{
	...
	// Calculo los angulos de Roll y Pitch
	Accel_Mag_Process.roll =  (int16_t) ((atan2(argx, sqrt(argz*argz + argy*argy)))*180/pi);
	Accel_Mag_Process.pitch = (int16_t) ((atan2(argy, argz))*180/pi);
